...
_BUILT_IN: tuple[Preset, ...] = (
    ...
    Preset("saturn", "Sega Saturn", CompressionFormat.CHD,
           {"chd_type": "createcd", "codecs": ["zlib"], "hunk_size": 0}),
    Preset("segacd", "Sega CD / Mega CD", CompressionFormat.CHD,
           {"chd_type": "createcd", "codecs": ["zlib"], "hunk_size": 0}),
    Preset("pcenginecd", "PC Engine CD", CompressionFormat.CHD,
           {"chd_type": "createcd", "codecs": ["zlib"], "hunk_size": 0}),
    Preset("neogeocd", "Neo Geo CD", CompressionFormat.CHD,
           {"chd_type": "createcd", "codecs": ["zlib"], "hunk_size": 0}),
    Preset("3do", "3DO", CompressionFormat.CHD,
           {"chd_type": "createcd", "codecs": ["zlib"], "hunk_size": 0}),
    Preset("pcfx", "PC-FX", CompressionFormat.CHD,
           {"chd_type": "createcd", "codecs": ["zlib"], "hunk_size": 0}),
    ...
    Preset("gbc", "Game Boy Color", CompressionFormat.SEVEN_ZIP,
           {"archive_type": "7z", "level": 9}),
    Preset("mastersystem", "Master System", CompressionFormat.SEVEN_ZIP,
           {"archive_type": "7z", "level": 9}),
    Preset("gamegear", "Game Gear", CompressionFormat.SEVEN_ZIP,
           {"archive_type": "7z", "level": 9}),
    Preset("sega32x", "Sega 32X", CompressionFormat.SEVEN_ZIP,
           {"archive_type": "7z", "level": 9}),
    Preset("pcengine", "PC Engine / TG-16", CompressionFormat.SEVEN_ZIP,
           {"archive_type": "7z", "level": 9},
           note="HuCard games only. The CD ones live in pcenginecd and become CHD."),
    Preset("sg-1000", "SG-1000", CompressionFormat.SEVEN_ZIP,
           {"archive_type": "7z", "level": 9}),
    ...
    Preset("arcade", "Arcade / Neo Geo / CPS", CompressionFormat.SEVEN_ZIP,
           {"archive_type": "zip", "level": 9},
           note="Covers ES-DE's arcade, neogeo and cps folders. Romsets stay ZIP."),
)
